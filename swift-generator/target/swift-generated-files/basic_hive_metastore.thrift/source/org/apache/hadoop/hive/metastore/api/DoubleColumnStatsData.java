...
public final class DoubleColumnStatsData
{
    @ThriftConstructor
    public DoubleColumnStatsData(
        @ThriftField(value=1, name="lowValue", requiredness=Requiredness.REQUIRED) final double lowValue,
        @ThriftField(value=2, name="highValue", requiredness=Requiredness.REQUIRED) final double highValue,
    ...
    public static class Builder {
        ...
        public Builder() { }
        public Builder(DoubleColumnStatsData other) {
        ...
        public DoubleColumnStatsData build() {
    ...
    public boolean equals(Object o) {
        ...
        DoubleColumnStatsData other = (DoubleColumnStatsData)o;
